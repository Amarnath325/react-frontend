...
import {
  BarChart2, CheckCircle, Plus, Search, Filter,
  Users, Clock, ChevronRight, Trash2, Bell,
  Star, MessageSquare, TrendingUp, Send, X,
  Edit3, Eye, ToggleLeft, ToggleRight, Award,
  PieChart, Activity, Layers, ChevronDown, ChevronUp,
  RefreshCw, ThumbsUp, BookOpen, Zap, Target,
  AlignLeft, List, CheckSquare, Hash
} from 'lucide-react';
