...
const ExaminationManager: React.FC = () => {
  ...
  const isTypes = location.pathname.includes('types');
  ...
  // Dynamic headers
  let pageTitle = 'Examination Manager';
  let pageDesc = 'Create, manage, and schedule school examinations and types.';

  if (isTypes) {
    pageTitle = 'Exam Type Management';
    pageDesc = 'Define and manage dynamic school examination types like Formative, Summative, and Term assessments.';
  } else if (isSetup) {
    pageTitle = 'Exam Setup Control';
    pageDesc = 'Create school examinations, configure terms, and set target max marks and passing marks thresholds.';
  } else if (isSchedule) {
    pageTitle = 'Exam Schedule Management';
    pageDesc = 'Define test dates and time slots, audit schedule conflicts, and import schedules via Excel.';
  }
